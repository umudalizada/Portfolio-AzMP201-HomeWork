...
const UserDetailo = () => {
  ...
  const find = allUser.find(item => item.id === detailId);

  return (
<section className="mt-10 p-4">
  <div className="w-full  md:mx-auto flex flex-col md:flex-row items-center justify-center text-center">
    <img
    ...
    <div className="flex flex-col">
      <div className="md:text-justify mb-3">
        <div className="flex flex-col mb-5">
          <p className="text-indigo-900 font-bold  text-x1">{find.name} {find.surname}</p>
        ...
        <p className="text-indigo-300 font-semibold text-center md:text-left">
          Name: {find.userName} | Email: {find.email} | Password: {find.password} | Gender: {find.gender} | Date: {find.date} | User: {find.user ? "Admin" : "User"}
        </p>
      </div>
    </div>
  </div>
